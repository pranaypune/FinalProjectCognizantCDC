...
1) src/test/java
       ...
       (package) testScenarios
            	- TS_01_NavigateToBookshelvesPage.java
			- TS_02_VisibilityOfBookshelvesFilters.java
			- TS_03_SettingTheRequiredFilters.java
			- TS_04_DisplayBookShelvesDetails.java
			- TS_05_GetListOfSubMenuItems.java
			- TS_06_GiftCardCustomization.java
			- TS_07_RecipientAndSenderDetails.java
			- TS_07_ResipientAndSenderDetailsDDT.java
