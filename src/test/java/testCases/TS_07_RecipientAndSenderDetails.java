...
public class TS_07_RecipientAndSenderDetails extends BaseClass {
	...
	public void tc_020_enterRecipientDetails() {
		logger = LogManager.getLogger(this.getClass());
		logger.info("*** Starting of TS_07_RecipientAndSenderDetails ***");
		try {
	...
	public void tc_021_validateErrorMessageWithoutNameInSenderDetails() {
		try {
			giftCards = new GiftCardsPage(driver);
			...
			giftCards.fillSendersAddress(propertyReader.readAddress());
			giftCards.fillSenderPin(propertyReader.readPincode());
	...
	public void tc_022_validateErrorMessageWithoutEmailInSenderDetails() {
		try {
			giftCards = new GiftCardsPage(driver);
	...
	public void tc_023_validateErrorMessageWithInvalidEmailInSenderDetails() {
		try {
			giftCards = new GiftCardsPage(driver);
			giftCards.clearSenderDetails();
	...
	public void tc_024_validateErrorMessageWithoutMobileNumberInSenderDetails() {
	...
	public void tc_025_validateErrorMessageWithInvalidMobileNumberInSenderDetails() {
		try {
			giftCards = new GiftCardsPage(driver);
			giftCards.clearSenderDetails();
	...
	public void tc_026_validateErrorMessageWithoutAddressInSenderDetails() {
		try {
			giftCards = new GiftCardsPage(driver);
		...
		logger.info("*** Ending of TS_07_RecipientAndSenderDetails ***");
	}
}
