...
public class TS_03_SettingTheRequiredFilters extends BaseClass {

	AddFluentWait wait = new AddFluentWait();
	BookShelvesPage bookShelves;
	
	@Test(priority = 0,groups= {"Regression Test","Master"})
	public void tc_010_setPriceSlider() {
		logger = LogManager.getLogger(this.getClass());
		logger.info("*** Starting of TS_03_SettingTheRequiredFilters ***");
		try {
	...
	public void tc_011_setStorageType() {
		try {
			bookShelves = new BookShelvesPage(driver);
	...
	public void tc_012_checkOutOfStock() {
		try {
			bookShelves = new BookShelvesPage(driver);
		...
		logger.info("*** Ending of TS_03_SettingTheRequiredFilters ***");
	}
}
