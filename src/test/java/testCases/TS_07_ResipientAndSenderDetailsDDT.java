...
public class TS_07_ResipientAndSenderDetailsDDT extends BaseClass{
	...
	public void tc_020_enterRecipientDetailsDDT(String name,String email,String mobile) {
	...
	public void tc_021_enterSenderDetailsDDT(String name,String email,String mobile,String address) throws IOException {
		try {
